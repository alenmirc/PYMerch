...
<body>
   <nav class="navbar navbar-expand-lg navbar-light sticky-top" style="background-color: #202020;">
      ...
      <h2 class="mt-5 ml-15 mb-1 text-center" style="color: white; font-family: Titillium Web;">- OTHER PRODUCTS -</h2>
     <br>
...
$sql = "SELECT id, product_name, category, user, target_file,  product_link FROM product WHERE category='4' ORDER BY id DESC";
$result = $db->query($sql);
