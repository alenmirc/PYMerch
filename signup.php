...
<h2>Register</h2>
        <div class="formContainer">
            ...
            <form method="post" action="#">
                ...
                <a style="margin-left:20px" href="login.php">Already have an account? Login</a><br>   
<?php
include("config.php");
...
if($check->num_rows >0){
  ...
  $db->query($sql);
  echo  "<div class='success'>Successfully Registered! Please login.</div>"; 
}
}
?>
